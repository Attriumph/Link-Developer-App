...
// @desc    Create or update the profile of current user
// @access  Private
router.post(
  '/',
  [
  ...
  async (req, res) => {
    ...
    try {
      ...
      // If find the profile of current user, then update it
      if (profile) {
...
// @desc    Delete the profile, posts and user of current user
// @access  Private
...
// @desc    Add experience of current user
// @access  Private
router.put(
  '/experience',
  [
...
// @desc     Get github repos of current user
// @access   Public
